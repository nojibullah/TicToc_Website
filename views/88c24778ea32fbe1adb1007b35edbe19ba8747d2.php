      ...
      <section class="section background-white text-center">
         ...
         <div class="line">
            ...
            <div style="width: 60%;margin: auto;">
               <a href="<?php echo e(url('/products')); ?>" class="s-12 m-6 l-3 center button border-radius background-primary text-size-20 margin-top-60 text-white" style="float: left;">View Products</a>
               <a href="<?php echo e(url('/recommendation')); ?>" class="s-12 m-6 l-3 center button border-radius background-primary text-size-20 margin-top-60 text-white" style="float: right;">Recommendations</a>
            </div>
         </div>
      </section>
      <!-- Section 2 -->
      ...
      <section class="  background-primary text-center" style="padding-bottom: 50px;">
         <div class="line">
            <div style="width: 93%;margin: auto;">
               <a href="<?php echo e(url('/our_service')); ?>" class="s-12 m-6 l-3 center button border-radius background-green text-size-20 margin-top-60 text-white" style="float: left;">View our repair services</a>
               <a href="<?php echo e(url('/send_message')); ?>" class="s-12 m-6 l-3 center button border-radius background-green text-size-20 margin-top-60 text-white" style="float: right;">Submit a repair service request</a>
            </div>
         </div>
      </section>
   </main>
...
</html><?php /**PATH D:\www_xampp\htdocs\ticktock\resources\views/welcome.blade.php ENDPATH**/ ?>