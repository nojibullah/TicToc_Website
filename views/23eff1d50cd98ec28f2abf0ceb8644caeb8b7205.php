                                        ...
                                        <div class="margin2x">
                                            ...
                                            <?php for($i=0;$i<count($watches);$i++): ?>
                                                <article class="s-12 m-12 l-4 margin-bottom-40" style="margin-top: 30px;" >
                                                    ...
                                                    <div style="min-height:65px; "><p><?php echo e($watches[$i]->description); ?></p></div>
                                                    ...
                                                    <a class="text-more-info text-primary margin-top-0" id = "go_buy" href="<?php echo e(url('/cart')); ?>" style="float: right;font-size: 16px;">Go Cart</a>
                                                    <hr>
                                                </article>
                                            <?php endfor; ?>
                                        </div>
...
</html><?php /**PATH D:\www_xampp\htdocs\ticktock\resources\views/home.blade.php ENDPATH**/ ?>