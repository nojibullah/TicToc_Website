                    ...
                    <table class="table">
                        ...
                        <?php for($i=0;$i<count($watches);$i++): ?>
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-outline-primary" id = "update<?php echo e($watches[$i]->id); ?>" data-toggle="modal" data-target="#exampleModalCenter<?php echo e($watches[$i]->id); ?>">Update</button></td>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <form method="post" action="<?php echo e(url('upload_repairing')); ?>">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="container">
                                                    <input type="text"   name="user_email" placeholder="" value="<?php echo e($repairing[$i]->email); ?>" style="display: none;">
...
</html><?php /**PATH D:\www\htdocs\ticktock123\resources\views/Admin/admin.blade.php ENDPATH**/ ?>