        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    ...
                    <form method="POST" action="<?php echo e(route('register')); ?>" style="width: 60%;">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="width: 200px; margin-left: 20px;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\www\htdocs\ticktock\resources\views/auth/register.blade.php ENDPATH**/ ?>